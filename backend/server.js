...
var endpoints_config_1 = require("./config/endpoints.config");
dotenv.config();
var app = (0, express_1.default)();
app.use(body_parser_1.default.json());
// express_rate_limit is used to protect your API from brute-force attacks.
        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                app.listen(endpoints_config_1.default.PORT, function () {
                    console.log("Server is running and listening on port ".concat(endpoints_config_1.default.PORT));
                });
                return [3 /*break*/, 3];
            case 2:
                err_1 = _a.sent();
                console.error("Failed to start server due to database connection error:", err_1);
                process.exit(1);
                return [3 /*break*/, 3];
